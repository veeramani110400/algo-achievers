...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-hero bg-grid-pattern flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center animate-fade-in">
          <div className="mx-auto w-16 h-16 bg-gradient-primary rounded-2xl flex items-center justify-center shadow-glow mb-6">
            <img src={dsaLogo} alt="SwitchWise" className="w-10 h-10 rounded-xl" />
          </div>
          <h1 className="text-3xl font-bold gradient-text">Start Your Journey</h1>
          <p className="text-muted-foreground mt-2">
            Create your account and accelerate your career growth
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm italic text-muted-foreground">
                  "Your career is a journey, not a destination. Every skill you learn today builds tomorrow's opportunities."
                </p>
                <p className="text-xs text-primary font-medium mt-1">- SwitchWise Team</p>
              </div>
            </div>
          </CardContent>
        </Card>
