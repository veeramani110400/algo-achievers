          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-primary font-medium mt-1">- Winston Churchill</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="card-modern animate-fade-in">
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button type="submit" className="w-full h-12 bg-gradient-primary hover:scale-105 transition-transform">
